...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            draw_list->AddRectFilledMultiColor(ImVec2(x, y), ImVec2(x + sz, y + sz), IM_COL32(0, 0, 0, 255), IM_COL32(0, 255, 0, 255), IM_COL32(255, 255, 0, 255), IM_COL32(0, 255, 0, 255));
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            if (draw_bg)
                ImGui::GetBackgroundDrawList()->AddCircle(window_center, window_size.x * 0.6f, IM_COL32(0, 255, 0, 200), 0, 10 + 4);
            if (draw_fg)
