...
namespace ImGui
{
    ...
    IMGUI_API bool          Keybind(const char* label, int* key, int* mode);

    IMGUI_API bool          Keybind(const char* label, int* key, int* mode, bool label_active = true);

    // Widgets
    IMGUI_API void          ShadowText(const char* label, ImU32 text_col, ImU32 bg_col, float shadow_thickness, const ImVec2& pos_text = ImVec2(0, 0));
    IMGUI_API void          ShimmerText(const char* text, ImVec4 baseColor, ImVec4 shimmerColor, ImVec2 pos, float time);
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API void          ImageRotation(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImU32 tint_col, float speed);
    ...
    IMGUI_API bool          InputTextExNew(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data);
